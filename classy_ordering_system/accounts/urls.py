...
from accounts.views import ResetPasswordView, ResetPasswordSuccessView, LoginView, logoutview, ForgotPasswordRequestView,FeedbackView
...
urlpatterns = [
    ...
    path('email-confirm/', TemplateView.as_view(template_name="accounts/email-confirm.html"),  name="sent-forgot-password-email"),
